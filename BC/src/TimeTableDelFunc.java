		...
		if (lecId.equals(""))
			...
			try {
				...
				PreparedStatement query = con
						.prepareStatement("select ltime from course c, lecture l where sid = ? and l.lid = ?");
				...
				if (rs.next()) {
					...
					if (c == 1) {
						...
						JOptionPane.showMessageDialog(null, "과목이 존재하지 않습니다.1");

				} else
					rs.getBoolean(1);

			} catch (SQLException sqex) {
				JOptionPane.showMessageDialog(null, "과목이 존재하지 않습니다.2");
			}
		}
	}

	public void stringToken(String lecTime) {
